...
namespace EngineTools
{
    ...
    public class CameraController : MonoBehaviour
    {
        ...
        [SerializeField, Range(1.0f, 40.0f)] public float CameraRotatationSentivity = 7.5f, CameraRotatationDelta = 5.0f;
        [SerializeField, Range(1.0f, 40.0f)] public float CameraTranslanslationSentivity = 7.5f, CameraTranslationDelta = 5.0f;
        ...
        void Update()
        {
            ...
            m_Camera.transform.rotation = Quaternion.Slerp(m_Camera.transform.rotation, m_LerpRotation, Time.deltaTime * CameraRotatationDelta);
            m_Camera.transform.position = Vector3.Lerp(m_Camera.transform.position, m_LerpTranslation, Time.deltaTime * CameraTranslationDelta);
        }
    }
}
