...
namespace KuwaharaFilterURP
{
    ...
    public class AnisotropicKuwaharaEffectURP : ScriptableRendererFeature
    {
        ...
        public KuwaharaFilterSettings Settings = new();
    ...
    public class KuwaharaFilterRenderPass : ScriptableRenderPass
    {
        ...
        {
            internal static readonly int TextureColor = Shader.PropertyToID("TextureColor");
            internal static readonly int TextureSST = Shader.PropertyToID("TextureSST");
            internal static readonly int TextureGaussVS = Shader.PropertyToID("TextureGaussVS");
            internal static readonly int TextureGaussHS = Shader.PropertyToID("TextureGaussHS");
            internal static readonly int TextureTFM = Shader.PropertyToID("TextureTFM");
            internal static readonly int TextureLIC = Shader.PropertyToID("TextureLIC");
            internal static readonly int TextureKuwahara = Shader.PropertyToID("TextureKuwahara");
        }
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            var width = Mathf.CeilToInt(m_Settings.ResolutionScale * descriptor.width);
            var height = Mathf.CeilToInt(m_Settings.ResolutionScale * descriptor.height);

         
            cmd.GetTemporaryRT(ShaderIDs.TextureColor, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureSST, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureGaussHS, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureGaussVS, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureTFM, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureLIC, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGBHalf, RenderTextureReadWrite.Linear, 1, true);
            cmd.GetTemporaryRT(ShaderIDs.TextureKuwahara, width, height, 0, FilterMode.Point, RenderTextureFormat.ARGB32, RenderTextureReadWrite.Linear, 1, true);

            m_TextureSrc = renderingData.cameraData.renderer.cameraColorTargetHandle;
            m_TextureDst = renderingData.cameraData.renderer.cameraColorTargetHandle;
        }

        public override void FrameCleanup(CommandBuffer cmd)
        {
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureColor);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureSST);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureGaussHS);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureGaussVS);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureTFM);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureLIC);
            cmd.ReleaseTemporaryRT(ShaderIDs.TextureKuwahara);
        }
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            commandBuffer.Blit(m_TextureSrc, ShaderIDs.TextureColor);
            {
                ...
                commandBuffer.SetComputeTextureParam(m_SSTComputer, kernel, "TextureColorSRV", ShaderIDs.TextureColor);
                commandBuffer.SetComputeTextureParam(m_SSTComputer, kernel, "TextureColorUAV", ShaderIDs.TextureSST);
...

            {
                ...
                commandBuffer.SetComputeTextureParam(m_GaussComputer, kernel, "TextureColorSRV", ShaderIDs.TextureSST);
                commandBuffer.SetComputeTextureParam(m_GaussComputer, kernel, "TextureColorUAV", ShaderIDs.TextureGaussHS);
...

            {
                ...
                commandBuffer.SetComputeIntParam(m_GaussComputer, "GaussRadius", m_Settings.GaussRadius);
                commandBuffer.SetComputeTextureParam(m_GaussComputer, kernel, "TextureColorSRV", ShaderIDs.TextureGaussHS);
                commandBuffer.SetComputeTextureParam(m_GaussComputer, kernel, "TextureColorUAV", ShaderIDs.TextureGaussVS);
                commandBuffer.SetComputeBufferParam(m_GaussComputer, kernel, "BufferGaussKernel", m_KernelGaussFilter);
                commandBuffer.DispatchCompute(m_GaussComputer, kernel, Mathf.CeilToInt(width / (float)groupSizeX), Mathf.CeilToInt(height / (float)groupSizeY), 1);
            }

            {
                ...
                commandBuffer.SetComputeTextureParam(m_TFMComputer, kernel, "TextureColorSRV", ShaderIDs.TextureGaussVS);
                commandBuffer.SetComputeTextureParam(m_TFMComputer, kernel, "TextureColorUAV", ShaderIDs.TextureTFM);
...

            {
                ...
                commandBuffer.SetComputeTextureParam(m_LICComputer, kernel, "TextureTFMSRV", ShaderIDs.TextureTFM);
                commandBuffer.SetComputeTextureParam(m_LICComputer, kernel, "TextureColorSRV", m_TextureSrc);
                commandBuffer.SetComputeTextureParam(m_LICComputer, kernel, "TextureColorUAV", ShaderIDs.TextureLIC);
...

            {
                ...
                commandBuffer.SetComputeTextureParam(m_KuwaharaComputer, kernel, "TextureTFMSRV", ShaderIDs.TextureTFM);
                commandBuffer.SetComputeTextureParam(m_KuwaharaComputer, kernel, "TextureColorSRV", ShaderIDs.TextureLIC);
                commandBuffer.SetComputeTextureParam(m_KuwaharaComputer, kernel, "TextureColorUAV", ShaderIDs.TextureKuwahara);
            ...
            commandBuffer.Blit(ShaderIDs.TextureKuwahara, m_TextureDst);
